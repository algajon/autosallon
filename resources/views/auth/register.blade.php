...
@section('content')
    ...
    <div class="max-w-md w-full space-y-8 p-8 pt-28 mx-auto">
        <div class="text-center">
            <h2 class="text-3xl font-bold text-white heading">KOREANCARS.KS</h2>
            <p class="mt-2 text-sm text-brand-muted">Create your account</p>
        </div>
        ...
        <form class="mt-8 space-y-6" method="POST" action="{{ route('register') }}">
            ...
            <div class="text-center">
                <p class="text-sm text-brand-muted">
                    ...
                    <a href="{{ route('login') }}" class="font-medium text-brand-red hover:text-brand-red-dark">
                        Sign in here
                    </a>
                </p>
            </div>
